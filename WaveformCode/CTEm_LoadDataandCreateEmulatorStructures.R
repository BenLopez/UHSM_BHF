...
if( DP_CheckfileinPrecomputedfolder(precomputedfolderpath,'EmulatingCriticalThresholdData.RData') ){
  ...
  outputstruct <- CTEm_CreateTrainingSet(x,PriorNonImplausibleSetTotal,F_total,f_total,MD_Total  ,numberofsimulations = numberofsimulations, c = c , l = l , N = n ,numberofrepeats = numberofrepeats)
